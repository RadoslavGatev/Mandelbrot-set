...
/**
 * This class converts a given set of colours to a spectrum of colours that
...
public class Gradient {
	...
	/**
	 * Creates a gradient object with the given number of unique colours cycling
	 * between the given list of fixed colour points
	 * 
	 * @param colours
	 */
	...
	private void fillColour(int startIndex, int numGrades, Color fromColour,
			Color toColour) {
		for (int i = startIndex; i < startIndex + numGrades; i++) {
			// Get the average red, blue and green between the from and to
			// colours at this index
			int r = fromColour.getRed()
					+ (int) ((toColour.getRed() - fromColour.getRed())
							* (i - startIndex) / numGrades);
			int g = fromColour.getGreen()
					+ (int) ((toColour.getGreen() - fromColour.getGreen())
							* (i - startIndex) / numGrades);
			int b = fromColour.getBlue()
					+ (int) ((toColour.getBlue() - fromColour.getBlue())
							* (i - startIndex) / numGrades);
